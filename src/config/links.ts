export const LINKS = {
  ...
  // Prefills an email to apps@opendatalabs.xyz with:
  // Subject: "DataConnect App Submission - [App Name]"
  // Body fields: app URL, one-sentence user value, demo URL, builder identity/contact, repo or verifiable profile link, and optional extra notes.
  appSubmissionEmail:
    "mailto:apps@opendatalabs.xyz?subject=DataConnect%20App%20Submission%20-%20%5BApp%20Name%5D&body=Hi%2C%0A%0AI%27d%20like%20to%20submit%20my%20app%20for%20DataConnect.%0A%0AApp%20URL%3A%0AUser%20value%20in%20one%20sentence%3A%0ADemo%20video%20URL%3A%0ATell%20us%20who%20you%20are%20(name%20%2B%20contact)%3A%0ADoes%20it%20have%20a%20repo%20or%20verifiable%20profile%3F%20(link)%3A%0A%0AAnything%20else%3A%0A%0AThanks",
} as const
