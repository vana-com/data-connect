...
export const TEST_FINISHED_IMPORTS: Run[] = [
  ...
  {
    id: "test-finished-chatgpt-partial",
    platformId: "chatgpt",
    filename: "chatgpt-export-partial.zip",
    exportPath: "/tmp/dataconnect/chatgpt/partial/export.json",
    isConnected: true,
    startDate: new Date(Date.now() - 3 * 60 * 60 * 1000).toISOString(),
    endDate: new Date(Date.now() - 2.5 * 60 * 60 * 1000).toISOString(),
    status: "partial",
    url: "https://chatgpt.com",
    company: "OpenAI",
    name: "ChatGPT",
    itemsExported: 30,
    itemLabel: "conversations",
    statusMessage: "Collection completed with partial data: 1 scope omitted",
  },
  {
