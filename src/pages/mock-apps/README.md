...
- Internal DataConnect testing only. In production, use `connect.vana.org`
...
- RickRoll mock app (external web flow):
  ...
  → in dev, Launch DataConnect routes to
...
Why "Launch DataConnect" may do nothing right now (non‑dev):
